...
#define __ESPUINO_SETTINGS_LOLIN_D32_PRO_H__
    ...
    */
    ...
    // Rotary encoder
        ...
        #define ROTARYENCODER_BUTTON        39          // (set to 99 to disable; 0->39 for GPIO; 100->115 for port-expander)
    #endif
    ...
    // (optional) Monitoring of battery-voltage via ADC
        ...
        constexpr float offsetVoltage = 0.3;                      // If voltage measured by ESP isn't 100% accurate, you can add an correction-value here
    #endif
